...
public interface IEZcommerceRepository
{
    ...
    Task<Product?> ProductGetByIdWithTrackingAsync(int id);
    Task<Product?> ProductGetByIdWithInventoryWithTrackingAsync(int id);
    Task<Product?> ProductGetByIdWithInventoryAsync(int id);
    Task<Product?> ProductGetByIdWithInventoryAndCategoryAsync(int id);
    Task ProductAddAndSaveAsync(Product product);
    Task ProductRemoveAndSaveAsync(Product product);

    Task<List<Order>> OrderGetAllAsync();
    Task<Order?> OrderGetByIdAsync(int id);
    Task<Order?> OrderGetByIdWithTrackingAsync(int id);
    ...
    Task<Payment?> PaymentGetByIdWithTrackingAsync(int id);
    Task PaymentAddAndSaveAsync(Payment payment);
    Task PaymentRemoveAndSaveAsync(Payment payment);
